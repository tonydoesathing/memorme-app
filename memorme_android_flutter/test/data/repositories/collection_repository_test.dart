...
main() {
  ...
  group("Collection Repository >", () {
    ...
    test(
        "Can save, retrieve, and delete collections, mcrelations with text story",
        () async {
      Collection c1 = Collection(
          ...
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(10000));
      Collection c2 = Collection(
          ...
          title: "hejj",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(20000));
      Collection c3 = Collection(
          ...
          title: "hejjj",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(30000));
      Collection c4 = Collection(
          ...
          title: "hejjjj",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(40000));
      ...
      MCRelation mc1 = MCRelation(
          id: 1,
          memoryID: 10,
          collectionID: 1,
          relationshipData: "Single",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(100000));
      MCRelation mc2 = MCRelation(
          id: 2,
          memoryID: 20,
          collectionID: 1,
          relationshipData: "Singl",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(200000));
      MCRelation mc3 = MCRelation(
          id: 3,
          memoryID: 30,
          collectionID: 1,
          relationshipData: "Sing",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(300000));
      MCRelation mc4 = MCRelation(
          id: 4,
          memoryID: 40,
          collectionID: 1,
          relationshipData: "Sin",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(400000));
      MCRelation mc5 = MCRelation(
          id: 5,
          memoryID: 50,
          collectionID: 2,
          relationshipData: "Si",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(500000));
      MCRelation mc6 = MCRelation(
          id: 6,
          memoryID: 60,
          collectionID: 2,
          relationshipData: "S",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(600000));
      MCRelation mc7 = MCRelation(
          id: 7,
          memoryID: 70,
          collectionID: 3,
          relationshipData: "So",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(700000));
      MCRelation mc8 = MCRelation(
          id: 8,
          memoryID: 80,
          collectionID: 4,
          relationshipData: "Sou",
          dateCreated: DateTime.now(),
          dateLastEdited: DateTime.fromMicrosecondsSinceEpoch(800000));
